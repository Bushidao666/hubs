...
export const saasApps: SaaSApp[] = [
  ...
  },
  {
    id: 'siderlink',
    name: 'Siderlink',
    description: 'Aplicativo Oficial da Blacksider - Central de controle e gestão do ecossistema',
    icon: 'siderlink',
    image: '/siderlink.png',
    url: 'https://siderlink.blacksider.hub',
    category: 'Integração',
    status: 'online',
    uptime: 99.99,
    activeUsers: 3250,
  ...
  },
  {
    id: 'hyper',
    name: 'Hyper',
    description: 'Gerador avançado de notificações mobile com personalização completa',
    icon: 'hyper',
    image: '/Hyper.png',
    url: 'https://hyper.blacksider.hub',
    category: 'Desempenho',
    status: 'online',
    uptime: 99.96,
    activeUsers: 4180,
